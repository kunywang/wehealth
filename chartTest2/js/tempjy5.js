window.onload=function(){
	...
	function showgasjyData(gasjyData){
		...
		if(temperature>=50){
			...
			$(".gasjyNav>div:nth-child(1)>img").attr("src","images/temperatureAlarm.png");
		}else{
			airFlag+=1;
			$(".gasjyNav>div:nth-child(1)").css(border,normalColor);
			$(".gasjyNav>div:nth-child(1)>img").attr("src","images/temperature.png");
		}
		
		if(airFlag>=5){
			var img="images/temperatureAlarm.png";
			var name="报警";
		}else{
			var img="images/temperature.png";
			var name="正常";
		}
